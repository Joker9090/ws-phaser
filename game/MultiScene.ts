  ...
  preload() {
    ...
    this.assetLoaderClass.runPreload(() => {
      if (this.scenekey) {
       ...
       // this.makeTransition("CinematographyMod", { keyname: "cine_3_movie_1", loadKey: ["Cinemato0", "Cinemato1", "Cinemato2", "Cinemato3"] });
         this.makeTransition("Game", { level: 11 , lifes: 99, loadKey: ["GamePlay1", "GamePlay2", "GamePlay3"] });
