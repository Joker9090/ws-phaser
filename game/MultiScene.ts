  ...
  preload() {
    ...
    this.assetLoaderClass.runPreload(() => {
      if (this.scenekey) {
        ...
        // this.makeTransition("CinematographyMod", { keyname: "postal1_Planeta3", loadKey: ["Cinemato0", "Cinemato1", "Cinemato2", "Cinemato3"] });
        this.makeTransition("Game", { level: 11 , lifes: 3, loadKey: ["GamePlay1", "GamePlay2", "GamePlay3"] });
