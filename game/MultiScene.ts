    ...
    console.log(this.scene.get("MultiScene"), "CAMBIANDO ESCENA 2", this.scenekey, this.sceneData);
      if (this.scenekey) {
        this.makeTransition(this.scenekey, this.sceneData ?? undefined);
          ...
          // this.makeTransition("Game", { level: 20101, lifes: 3, loadKey: ["GamePlay1", "GamePlay2", "GamePlay3", "Postales","Cinemato0", "Cinemato1", "Cinemato2", "Cinemato3", "Postales"] });
          this.makeTransition("Game", { level: 5, lifes: 3, loadKey: ["GamePlay1", "GamePlay2", "GamePlay3", "Postales","Cinemato0", "Cinemato1", "Cinemato2", "Cinemato3", "Postales"] });
