...
class Mapa5 {
  ...
  originalPositionsBackgroundsFront: {x: number, y:number}[]
    ...
    createMap(data: { level: number; lifes: number }) {
        ...
        const fireball4 = new Floor(this.scene, fireball4Config, this.fireballGroup).setScale(0.5).setFlipY(true)
        ...
        const fireball5 = new Floor(this.scene, fireball5Config, this.fireballGroup).setScale(0.5).setFlipY(true)
        ...
        const p10 = new Floor(this.scene, p10Config, this.pisos5).setFlipY(true).setTint(Phaser.Display.Color.GetColor(255, 101, 0));
