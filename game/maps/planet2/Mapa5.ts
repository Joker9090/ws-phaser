...
class Mapa5 {
  ...
  createMap(data: { level: number; lifes: number }) {
    ...
    this.pisos4 = this.scene.physics.add.group({ allowGravity: false, allowDrag: false });
    ...
    const fireball2 = new Floor(this.scene, fireball2Config, this.fireballGroup)
      .setScale(0.5)
      .setFlipY(true);
    ...
    const fireball4 = new Floor(this.scene, fireball4Config, this.fireballGroup)
      .setScale(0.5)
      .setFlipY(true);
    ...
    const p7 = new Floor(this.scene, p7Config, this.pisos4).setFlipY(true);
    ...
    const p8 = new Floor(this.scene, p8Config, this.pisos4).setFlipY(true);

    const fireball5Config: FloorConfig = {
      spriteSheet: "meteoritop1",
      texture: "meteoritop1",
      pos: { x: 2450, y: 0 }, // 500 1580
      width: 100,
      height: 100,
      tween: {
        duration: 7000,
    ...
    const fireball5 = new Floor(this.scene, fireball5Config, this.fireballGroup)
      .setScale(0.5)
      .setFlipY(false);
    ...
    const p9 = new Floor(this.scene, p9Config, this.pisos4).setFlipY(true);
    ...
    //     height: 50,
    // };
    // const p9 = new Floor(this.scene, p9Config, this.pisos5).setFlipY(true);

    const p11Config: LargeFloorIslandConfig = {
      textureA: "longFloorLeftp1",
    ...
    const p11 = new LargeFloorIsland(this.scene, p11Config, this.pisos);
