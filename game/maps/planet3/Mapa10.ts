...
originalPositionsBackgroundsFront: {x: number, y:number}[]
    ...
    this.background3 = this.scene.add
      ...
      .image(this.startingPoint.x, this.startingPoint.y + 650, "background3p3")
      .setOrigin(0.5, 0.5)
      .setAlpha(1)
      .setScale(2);
    this.background5 = this.scene.add
      .image(this.startingPoint.x + this.background4.width * 1.9 + 193 , this.startingPoint.y + 650, "background3p3")
      .setOrigin(0.5, 0.5)
      .setAlpha(1)
      .setScale(2);     
    ...
    this.hueso1 = this.scene.add
      .image(this.startingPoint.x - 150, this.startingPoint.y + 850, "planta1p3")
      .setOrigin(0.5, 1)
      .setScale(0.5);
    ...
    this.hueso3 = this.scene.add
      .image(2450, this.startingPoint.y + 850, "planta1p3")
      .setOrigin(0.5, 1)
      .setScale(0.6,0.7);
    ...
    this.hueso5 = this.scene.add
      ...
      .image(2850 , this.startingPoint.y + 850, "planta2p3")
      .setOrigin(0.5, 1)
      .setScale(1)
      .setFlipX(true)
      .setScale(0.4);
