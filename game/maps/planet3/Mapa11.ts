...
class Mapa11 {
  ...
  originalPositionsBackgroundsFront: {x: number, y:number}[]
    ...
    this.background5 = this.scene.add
      .image(this.startingPoint.x + this.background4.width * 1.9 + 192 , this.startingPoint.y + 450, "background3p3")
      .setOrigin(0.5, 0.5)
      .setAlpha(1)
      .setScale(2);    
    ...
    this.frontground1 = this.scene.add
      .image(this.startingPoint.x, this.startingPoint.y + 880, "background2p3")
      .setOrigin(1, 1)
      .setScale(1);
    this.frontground2 = this.scene.add
      .image(
        this.startingPoint.x - 5,
        this.startingPoint.y + 880,
        "background2p3"
      )
      .setOrigin(0, 1)
      .setScale(1)
    ...
    this.hueso1 = this.scene.add
      .image(this.startingPoint.x, this.startingPoint.y + 850, "planta1p3")
      .setOrigin(0.5, 1)
      .setScale(0.5);
    this.hueso2 = this.scene.add
      .image(3000, this.startingPoint.y + 850, "planta2p3")
      .setOrigin(0.5, 1)
      .setScale(1)
      .setFlipX(true)
      .setScale(0.4);
    this.hueso3 = this.scene.add
      .image(1750, this.startingPoint.y + 850, "planta1p3")
      .setOrigin(0.5, 1)
      .setScale(1.1,1);

      this.hueso4 = this.scene.add
      .image(this.startingPoint.x * 1.6, this.startingPoint.y + 850, "planta3p3")
      .setOrigin(0.5, 1)
      .setScale(0.5);
    this.hueso5 = this.scene.add
      .image(3000 * 2.1, this.startingPoint.y + 850, "planta2p3")
      .setOrigin(0.5, 1)
      .setScale(1)
      .setFlipX(true)
      .setScale(0.4);
    this.hueso6 = this.scene.add
      .image(4650* 2.5, this.startingPoint.y + 850, "planta3p3")
      .setOrigin(0.5, 1)
      .setScale(1,0.7);
    this.mountain1 = this.scene.add.image(
      200,
      this.startingPoint.y + 650,
      "montaña1p3"
    );
    this.mountain2 = this.scene.add.image(
      1100,
      this.startingPoint.y + 670,
      "montaña2p3"
    );
    this.mountain3 = this.scene.add
      .image(2300, this.startingPoint.y + 550, "montaña3p3")
      .setScale(1.3);
    this.mountain4 = this.scene.add
      .image(3400, this.startingPoint.y + 670, "montaña2p3")
      .setScale(1.1);
    this.mountain5 = this.scene.add
      .image(4000, this.startingPoint.y + 650, "montaña1p3")
      .setScale(0.81);
...
const p12 = new Floor(this.scene, p12Config, this.pisos2).setTint(Phaser.Display.Color.GetColor(255, 101, 0));
