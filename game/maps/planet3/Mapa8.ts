...
class Mapa8 {
    ...
    createMap(data: { level: number; lifes: number }) {
        ...
        const p2Config: FloorConfig = {
            texture: "plataformaNuevaA", // B
            pos: { x: 900, y: 1020 }, // posicion
            fix: 25,
            scale: { width: 0.7, height: 0.7 },
            width: 140,
            height: 50,
        };
        const p2 = new Floor(this.scene, p2Config, this.pisos).setTint(255, 255, 0)

        // ACA VAS A METER TODO EL CÓDIGO
