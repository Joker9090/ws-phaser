...
class startMovie extends Phaser.Scene {
    ...
    //     this.load.audio("intro1audio1", "/movies/intro/audios/cineIntro1/intro1audio1.mp3")
    //     this.load.audio("intro1audio2", "/movies/intro/audios/cineIntro1/intro1audio2.mp3")
    //     this.load.audio("intro2audio1", "/movies/intro/audios/cineIntro2/intro2audio1.mp3")
    //     this.load.audio("intro2audio2", "/movies/intro/audios/cineIntro2/intro2audio2.mp3")
    //     this.load.audio("intro2audio3", "/movies/intro/audios/cineIntro2/intro2audio3.mp3")
    //     this.load.audio("intro2audio4", "/movies/intro/audios/cineIntro2/intro2audio4.mp3")
    //     this.load.audio("intro2audio5", "/movies/intro/audios/cineIntro2/intro2audio5.mp3")
    //     this.load.audio("intro2audio6", "/movies/intro/audios/cineIntro2/intro2audio6.mp3")
    //     this.load.audio("intro2audio7", "/movies/intro/audios/cineIntro2/intro2audio7.mp3")
    //     this.load.audio("intro6audio1", "/movies/intro/audios/cineIntro6/intro6audio1.mp3")
    //     this.load.audio("intro7audio1", "/movies/intro/audios/cineIntro7/intro7audio1.mp3")
    //     // soundEffects
